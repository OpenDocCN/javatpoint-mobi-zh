...
由于 Kotlin 与 Java 完全互操作，我们可以访问 Java 类(或 POJO 类)的 *getter* 和 *setter* 功能。例如，在 Java 类*MyJava.java*中创建一个 getter 和 setter 方法，属性为*名字*和*姓氏*。这些属性是通过Kotlin文件中*MyJava.java*的创建对象从Kotlin文件 *MyKotlin.kt* 中访问的。
...
| java.lang.Float | Kotlin浮？ |
| java.lang.Double | Kotlin！Kotlin！双份？ |
| java.lang.Boolean | Kotlin布尔？ |
