...
> 原文:[https://www.javatpoint.com/flutter-toast-notification](https://www.javatpoint.com/flutter-toast-notification)
...
**第二步:**在[安卓工作室](https://www.javatpoint.com/android-studio)打开项目，导航至 **lib** 文件夹。在该文件夹中，打开**publispec . YAML**文件。在这里，我们需要在依赖部分添加 flutter toast 库，然后点击**获取包**链接，在您的 **main.dart** 文件中导入该库。
...
![Flutter Toast Notification](../Images/c7c9a563027dd702551fb368a40f96cf.png)

当我们点击**“点击显示”**按钮时，我们可以在屏幕底部看到敬酒信息。请参见下图:

![Flutter Toast Notification](../Images/14bba7a543e7b76197292ee55e83b651.png)
