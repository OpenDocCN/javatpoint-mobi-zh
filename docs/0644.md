...
在本节中，我们将学习如何使用 **AngularFire** 包将我们的应用程序连接到 Firebase，在 Ionic Framework 中创建 **CRUD** (创建、读取、更新和删除)应用程序。让我们一步一步来看看带有 Firebase 的Ionic应用。

**步骤 1:** 创建新项目。你可以从[这里](https://www.javatpoint.com/ionic-installation)学习如何在Ionic 4 中创建一个项目。如果您已经有了一个Ionic项目，您可以跳过这一步。
