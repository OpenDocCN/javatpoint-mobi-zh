...
> 原文：<https://www.javatpoint.com/android-data-recovery>
...
![Android Data Recovery](img/1f91707309babc61e07106df0e714f80.png)

b)安装成功后，打开它，它会显示要执行的不同操作，如恢复、数据传输、恢复社交应用

![Android Data Recovery](img/300505ed476076dd2b40a019446cff96.png)

c)在选择任何操作之前，使用 USB 电缆将智能手机与电脑连接。否则，它会抛出一个异常，在屏幕上显示“将您的设备连接到电脑”。

![Android Data Recovery](img/748493738ff2413e4adca13b4ef7f027.png)

在这个过程中，不要启动任何其他安卓手机管理软件。

![Android Data Recovery](img/9d489441d7db13438a5af227e41d1134.png)

d)一旦你使用这个软件将你的安卓设备与 PC 连接，它就会在应用程序中显示出来(在我们的例子中，它有一个三星安卓设备)。之后，选择要恢复的类别，点击**下一步**。

![Android Data Recovery](img/71522d143e2b96708b41f2939d9f2292.png)

e)最后，它会显示您丢失的数据。点击**恢复**恢复您的数据。

![Android Data Recovery](img/2eb6557facbdbafbe7b699cc63fb98d2.png)
...
![Android Data Recovery](img/c14fe8ce0a9bd16ec250c8d96120fb86.png)

![Android Data Recovery](img/de4e5d50000af4e9e4ca008f8bbfc5f4.png)

![Android Data Recovery](img/63744cf4fd465680df2506f03004afe8.png)

b)启动软件并使用 USB 电缆连接您的安卓设备。

![Android Data Recovery](img/dfb7cce2a84bf6fd9e4432511c96c9fb.png)

![Android Data Recovery](img/07b68ff212e19811da4978d84e0b441b.png)

![Android Data Recovery](img/3c853b70da83af7cdba5f5bea9420286.png)

打开你的 u 盘。它会自动扫描你的智能手机并分析数据。

点击**转到**扫描你的设备。之后，它可以帮助你找出所有丢失的文件。

![Android Data Recovery](img/b60a8bf9813cef6846bf27a64d9bc48f.png)

c)预览丢失的数据，轻松决定恢复什么和不恢复什么。选择要恢复的丢失文件，点击**恢复**。

![Android Data Recovery](img/2a45f5c4f1edd1c39e7585dbcd792013.png)
...
![Android Data Recovery](img/0a38e2d0fd2b5aafa9c327bbb31d9b16.png)
...
![Android Data Recovery](img/fe0cc9ca3d95e978a4d7582519c159c8.png) ![Android Data Recovery](img/c33678693b333f6b873fd9fe5ce320f3.png)

b)在几分钟内完成扫描您的安卓手机或 SD 卡，以搜索已删除的联系人、照片、视频、通话记录、短信和 WhatsApp 消息。在扫描过程中，它会列出已删除的文件。

![Android Data Recovery](img/9961c76e645ecdfa7a17c5528a8bbb9d.png)
...
![Android Data Recovery](img/85d6457c2ae365361099d5bb1e405a62.png)

### a)启动数据恢复软件，连接你的安卓系统

启动你的软件，它会在窗口上显示各种工具。点击“安卓数据恢复”选项。使用 USB 电缆将您的 Android 智能手机连接到电脑。

![Android Data Recovery](img/7068e284e318405be24a362218d6d0fe.png)

![Android Data Recovery](img/e0a2e49276c7ab719c4569db0faca826.png)
...
![Android Data Recovery](img/fc7e1622ce19f024f9017d7f4586a367.png)

### c)选择要在手机内部存储器中扫描的文件类型

该软件的界面显示了可以恢复的不同类型的文件。它包括联系人、短信、音频、视频、通话记录、图库，甚至是 WhatsApp 消息和附件。勾选要检索的文件类型框，点击**下一步**开始扫描。

![Android Data Recovery](img/052b1df6488ff077a8cdd2767cbfd2e3.png)
...
![Android Data Recovery](img/a8461c221e4369c419b1d713afb6d6b4.png)
