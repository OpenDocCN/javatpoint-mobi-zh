...
> 原文:[https://www.javatpoint.com/flutter-first-application](https://www.javatpoint.com/flutter-first-application)
...
![Flutter First Application](../Images/cbf9fb6d1a533424d8265c47b5fb28ff.png)

**步骤 3:** 在下一个向导中，您需要选择 Flutter Application。为此，选择颤振应用- >点击下一步，如下图所示。

![Flutter First Application](../Images/e65298fe1afe0196d77d9bed22b52dba.png)
...
![Flutter First Application](../Images/2457b75eb8c6d87a3221cad36562bbe7.png)

**第五步:**在下一个向导中，需要设置公司域名，点击完成按钮。

![Flutter First Application](../Images/3cbb82553297e07337d92751a1a2ce77.png)

单击“完成”按钮后，创建项目将需要一些时间。当项目被创建时，你将得到一个功能最少的完整的 Flutter 应用程序。

![Flutter First Application](../Images/1185bddbafa274f3c3e446c7f6570bdd.png)

**步骤 6:** 现在，让我们检查 Flutter 项目应用程序的结构及其用途。在下图中，您可以看到 Flutter 应用程序结构的各种文件夹和组件，这将在这里讨论。

![Flutter First Application](../Images/f437fbcf20d5456f126d027a272b3a92.png)
...
![Flutter First Application](../Images/a412411e6205429d890401a0a1df7071.png)

**第十步:**最后你会得到如下画面的输出。

![Flutter First Application](../Images/975a159187e261d74730535ae44ae5dd.png)
