...
**步骤 1:** 首先，您需要在 IDE 中创建一个 Flutter 项目。在这里，我将使用AndroidStudio。
...
现在，在你的AndroidStudio运行这个应用。它将给出如下屏幕，您可以在其中看到两个选项卡图标。因此，当您单击任何选项卡图标时，它将显示相关的屏幕。
...
在AndroidStudio创建一个 Flutter 项目。打开 **main.dart** 文件，替换如下代码。
