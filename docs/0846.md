...
现在，是时候讨论混合移动应用开发的顶级 Cordova 框架了:
...
Ionic 被定义为**麻省理工学院许可的**免费**和**开源项目**。**由**漂移股份有限公司**于 **2012** 开发，建在**角形**之上。它用于使用不同的网络技术开发混合应用程序，如 **HTML5、CSS 和 SASS** 等。它由 120 个原生功能组成，如蓝牙、指纹认证、健康工具包等。
...
这是另一个由**Apache**授权的**开源框架**。它是**框架不可知的，**这意味着你可以在不同的框架之间切换，比如 Angular 或者 React 来开发混合应用。

这是一个基于定制元素的 **HTML5** 框架，提供大量组件选择和响应布局支持。这个框架是新的，但给了 Ionic 激烈的竞争。所有商业项目也是**免费的。**
...
*   它使开发人员能够通过 Cordova 和 PhoneGap 用 HTML、JavaScript 编写代码。
