...
> 原文：<https://www.javatpoint.com/adobe-phonegap-build>
...
![Adobe PhoneGap Build](img/58c827a8feabe5fd11ff5a08fda6043e.png)

现在，我们将使用我们的电子邮件 id 登录或注册 Adobe PhoneGap Build。

![Adobe PhoneGap Build](img/7389819366a954918277069018cab988.png)
![Adobe PhoneGap Build](img/a6379339c73567c265cd323356b172a9.png)

点击**完成**后，我们将进入 Adobe PhoneGap Build 的欢迎页面。

![Adobe PhoneGap Build](img/c8895d2282045ab6bea28b9a6250d727.png)
...
![Adobe PhoneGap Build](img/bc2367954b9b90d13444b3a18312b80c.png)

上传 zip 文件后，我们将提交更改并复制我们项目的 GitHub 存储库。

![Adobe PhoneGap Build](img/8cc4dc3c5d4661047c5f1064c746fe4b.png)

接下来，我们将把我们的 [GitHub](https://www.javatpoint.com/github) 存储库粘贴到 **paste.git repo** 字段，然后点击**拉取。git 存储库按钮**。

![Adobe PhoneGap Build](img/0088fbcaba806a71476d576dd401eb2f.png)

### 2)私人

如果我们选择私有选项，我们可以通过点击**上传一个. zip 文件**按钮上传我们项目的 zip 文件，或者可以粘贴。将我们项目的 git 存储库粘贴到**中。git 回购**字段。

![Adobe PhoneGap Build](img/cecb53dc76985dc76146c2a020e53770.png)
![Adobe PhoneGap Build](img/0b1f6abdb2f4647727d3f7545f789917.png)

当我们的项目上传完成后，我们将以以下方式查看我们的项目:

![Adobe PhoneGap Build](img/c7f23109ed667085a914310a94fa3461.png)
...
![Adobe PhoneGap Build](img/09fab61de37836a37035422285a6f122.png)

我们将点击所需的平台，即安卓、视窗或 iOS，下载我们的应用程序。

![Adobe PhoneGap Build](img/cfafcba1eafc7481c006cee5974c7128.png)
![Adobe PhoneGap Build](img/e636589738b7854a07e89a4a58f9453e.png)
